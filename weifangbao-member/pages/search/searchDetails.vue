<template>
	<view class="content">
		...
		<view class="selectBox1" v-show="isChangeCondition" @touchmove.stop>
      ...
      <view class="selectLeft">
		...
		<view class="selectBox1" v-show="isPrice" @touchmove.stop>
			<view class="selectLeft">
			...
			<view class="selectRight" v-show="isAllPrice">
		...
		<view class="selectBox1" v-show="isSort" @touchmove.stop>
    ...
    <scroll-view scroll-y="true" class="selectBox2" v-show="isScreen" @touchmove.stop>
		<view  >
					...
					<view class="listRight">
						<view class="nameBox">
							<view class="houseName">{{item.propertyName}}</view>
								<view class="state" v-if="item.saleStatus">{{item.saleStatus}}</view>
						</view>
						<view class="houseAddress">
...
<script>
    ...
    onShow() {
      ...
      this.getAreaList();
		...
		onLoad(options) {
      if(options.keywords){
            this.propertyName=options.keywords
          }
		this.getData(0);
		this.getSelectId();
		},
